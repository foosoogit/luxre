...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('points', function (Blueprint $table) {
            ...
            $table->string('validity_flg',10)->nullable()->comment('有効フラグ');
            $table->string('digestion_flg',10)->nullable()->comment('消化フラグ');
            $table->string('point_expiration_date',10)->nullable()->comment('ポイント消滅日');
